...
export default function CartDrawer() {
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed inset-y-0 right-0 z-50 flex w-full max-w-sm flex-col border-l border-white/10 bg-[#0d0d0d] transition-transform duration-300 ease-out ${
        ...
        {items.length === 0 ? (
          <div className="flex flex-1 flex-col items-center justify-center gap-4 px-6 text-center">
            ...
            <Link
              to="/collections"
              onClick={() => setDrawerOpen(false)}
              className="border border-white px-5 py-2.5 text-sm transition-colors hover:bg-white hover:text-black"
            >
              Browse posters
            </Link>
          </div>
          ...
          <>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center border border-white/20">
                        <button
                          ...
                          className="h-7 w-7 text-sm transition-colors hover:bg-white hover:text-black"
            ...
            <div className="border-t border-white/10 px-5 py-5">
              ...
              <Link
                to="/checkout"
                onClick={() => setDrawerOpen(false)}
                className="block w-full bg-white py-3 text-center text-sm font-medium text-black transition-opacity hover:opacity-80"
              >
                Checkout
              </Link>
            </div>
